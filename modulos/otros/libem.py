...
# 20240613
# Esta función puede mejorarse muchísimo, sobre todo respecto a las escalas y unidades.
def equipotencialesPuntualesInteractivo(Q, V, dim = 100, levels = 10, figsize=(6,6), titulo='Equipotenciales',
            density=0.75, dq=0.02, **params):
    """
    Grafica equipotenciales generadas por la distribución de cargas Q, con voltajes calculados 
    usando la función V.
    ...
    *Parámetros que difieren de la función equipotencialesPuntuales:*
    xrange, yrange, zrange : list
        El rango para el slider relacionado al plano seleccionado.
